 ...
 * {@link io.netty.channel.jsc.DefaultJSerialCommChannelConfig} allows the following options in the option map:
 *
 * <table border="1" cellspacing="0" cellpadding="6">
 * <tr>
 * <th>Name</th><th>Associated setter method</th>
 * </tr><tr>
 * <td>{@link io.netty.channel.jsc.JSerialCommChannelOption#BAUD_RATE}</td><td>{@link #setBaudrate(int)}</td>
 * </tr><tr>
 * <td>{@link io.netty.channel.jsc.JSerialCommChannelOption#STOP_BITS}</td><td>{@link #setStopbits(Stopbits)}</td>
 * </tr><tr>
 * <td>{@link io.netty.channel.jsc.JSerialCommChannelOption#DATA_BITS}</td><td>{@link #setDatabits(int)}</td>
 * </tr><tr>
 * <td>{@link io.netty.channel.jsc.JSerialCommChannelOption#PARITY_BIT}</td><td>{@link #setParitybit(Paritybit)}</td>
 * </tr><tr>
