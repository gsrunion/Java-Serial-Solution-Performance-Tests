...
public class PureJavaCommStreamingSerialClientPerformanceTest {
	private PureJavaCommStreamingSerialClient server;
	private PureJavaCommStreamingSerialClient client;
	...
	@Test
	public void testTiming() throws InterruptedException, TimeoutException, ExecutionException, IOException, PortInUseException, NoSuchPortException, UnsupportedCommOperationException {
		if(server.open()) {
